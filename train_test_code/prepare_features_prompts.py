...
instance_dir = '/home/marinin2/Documents/skin_lesion/datasets/'

#OUTPUT_folder = args.output_folder
print("CREATE DIRECTORY WHERE MODELS WILL BE STORED")

OUTPUT_folder = '/data/marinin2/skin_lesion/model_weights/'
...
MAIN_FOLDER = '/home/marinin2/Documents/skin_lesion/datasets/'
MAIN_FOLDER = '/data/marinin2/skin_lesion/datasets/'
CSV_FOLDER = '/data/marinin2/skin_lesion/csv_folder/'
...
features = np.reshape(features, (len(list_terminology), hidden_dim))


#save features
features_filename = features_dir + 'cls_reports.npy'
with open(features_filename, 'wb') as f:
	np.save(f, features)

#save list
features_csv_filename = features_dir + 'list_keywords.csv'

File = {'keywords':list_terminology}
