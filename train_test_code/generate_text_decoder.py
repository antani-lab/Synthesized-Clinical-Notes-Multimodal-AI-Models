...
OUTPUT_folder = '/PLACE_HOLDER/MODEL_FLD/'
...
test_dataset = utils_data.get_instances_txt_generation(MAIN_FOLDER, [DATASET], flag_all, CNN_TO_USE, MODALITY, N_EXP_str, CSV_FOLDER)
